...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if len(btn) > 10: 
            ...
            if poster:
                await message.reply_photo(photo=poster, caption=f"<b>🎬  YOUR REQEST : {search} ‌‌‌‌‎ ­  ­  ­  ­  ­  \n✅  UPLOADED : @MLM_ROKES</b>\n<b>href=<a>"https://t.me/mlm_movies_update">ഈ എഴുത്തിൽ ക്ലിക്ക് ചെയ്ത് കിട്ടുന്ന ചാനലിൽ ജോയിൻ ചെയ്ത ശേഷം താഴെ ഉള്ള ബട്ടൺ ക്ലിക്ക് ചെയ്യുക</a></b>", reply_markup=InlineKeyboardMarkup(buttons))
