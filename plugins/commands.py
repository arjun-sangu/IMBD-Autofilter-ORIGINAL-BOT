...
async def start(bot, cmd):
    ...
    if usr_cmdall1.startswith("/start subinps"):
        ...
        await cmd.reply_text(
            text="Hi, I'm ADV AUTO FILTER WITH IMDB BOT.\nഎന്നെ @NEW_MLM_HD_MOVES ഗ്രൂപ്പിൽ മാത്രേ ഉപയോഗിക്കാൻ പറ്റൂ.സിനിമ വേണമെങ്കിൽ ഗ്രൂപ്പിൽ പോയി ചോദിക്ക് അല്ലാതെ എന്നെ ചൊറിയാൻ വരണ്ട..😒",
            parse_mode="Markdown",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
