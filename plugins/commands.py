    ...
    if usr_cmdall1.startswith("/start subinps"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=cmd.from_user.id,
                    text=f"ദയവായി ഞങ്ങളുടെ <a href='https://t.me/mlm_movies_update'>UPDATE CHANNEL</a> ഇല് ജോയിൻ ചെയ്യുക.എന്നാൽ മാത്രേ എനിക്ക് സിനിമ അയക്കാൻ സാധിക്കൂ..\n ജോയിൻ ചെയ്തശേഷം താഴെ കാണുന്ന 🔂 TRY AGAIN ബട്ടൺ ക്ലിക്ക് ചെയ്യുക. \n\n Please join our <a href='https://t.me/mlm_movies_update'>UPDATE</a> CHANNEL .Only then can I send the movie..\n After joining, click on the 🔂 TRY AGAIN button below.",
